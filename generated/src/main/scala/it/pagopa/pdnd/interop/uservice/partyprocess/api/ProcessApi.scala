...
processService.confirmOnBoarding(token = token, contract = contract)
  ...
  def activateRelationship400(responseProblem: Problem)(implicit toEntityMarshallerProblem: ToEntityMarshaller[Problem]): Route =
            complete((400, responseProblem))
  def activateRelationship404(responseProblem: Problem)(implicit toEntityMarshallerProblem: ToEntityMarshaller[Problem]): Route =
   ...
   * Code: 404, Message: Not found, DataType: Problem
        */
        def activateRelationship(relationshipId: String)
            (implicit toEntityMarshallerProblem: ToEntityMarshaller[Problem], contexts: Seq[(String, String)]): Route

          def confirmOnBoarding200: Route =
            complete((200, "successful operation"))
  def confirmOnBoarding400(responseProblem: Problem)(implicit toEntityMarshallerProblem: ToEntityMarshaller[Problem]): Route =
            complete((400, responseProblem))
        /**
           * Code: 200, Message: successful operation
   * Code: 400, Message: Invalid ID supplied, DataType: Problem
        */
        def confirmOnBoarding(token: String, contract: (FileInfo, File))
            (implicit toEntityMarshallerProblem: ToEntityMarshaller[Problem], contexts: Seq[(String, String)]): Route

          def createLegals201(responseOnBoardingResponse: OnBoardingResponse)(implicit toEntityMarshallerOnBoardingResponse: ToEntityMarshaller[OnBoardingResponse]): Route =
            complete((201, responseOnBoardingResponse))
  def createLegals400(responseProblem: Problem)(implicit toEntityMarshallerProblem: ToEntityMarshaller[Problem]): Route =
            complete((400, responseProblem))
        /**
           * Code: 201, Message: successful operation, DataType: OnBoardingResponse
   * Code: 400, Message: Invalid ID supplied, DataType: Problem
        */
        def createLegals(onBoardingRequest: OnBoardingRequest)
  ...
  def createOperators400(responseProblem: Problem)(implicit toEntityMarshallerProblem: ToEntityMarshaller[Problem]): Route =
            complete((400, responseProblem))
        /**
  ...
  def getOnBoardingInfo400(responseProblem: Problem)(implicit toEntityMarshallerProblem: ToEntityMarshaller[Problem]): Route =
            complete((400, responseProblem))
        /**
  ...
  def getOnboardingDocument404(responseProblem: Problem)(implicit toEntityMarshallerProblem: ToEntityMarshaller[Problem]): Route =
            complete((404, responseProblem))
  def getOnboardingDocument400(responseProblem: Problem)(implicit toEntityMarshallerProblem: ToEntityMarshaller[Problem]): Route =
            complete((400, responseProblem))
        /**
   ...
   * Code: 400, Message: Bad request, DataType: Problem
        */
        def getOnboardingDocument(relationshipId: String)
            (implicit toEntityMarshallerProblem: ToEntityMarshaller[Problem], toEntityMarshallerFile: ToEntityMarshaller[File], contexts: Seq[(String, String)]): Route

          def getRelationship200(responseRelationshipInfo: RelationshipInfo)(implicit toEntityMarshallerRelationshipInfo: ToEntityMarshaller[RelationshipInfo]): Route =
            complete((200, responseRelationshipInfo))
  def getRelationship400(responseProblem: Problem)(implicit toEntityMarshallerProblem: ToEntityMarshaller[Problem]): Route =
            complete((400, responseProblem))
  def getRelationship404(responseProblem: Problem)(implicit toEntityMarshallerProblem: ToEntityMarshaller[Problem]): Route =
            complete((404, responseProblem))
        /**
   ...
   * Code: 404, Message: Not found, DataType: Problem
        */
        def getRelationship(relationshipId: String)
          ...
          def getUserInstitutionRelationships200(responseRelationshipInfoarray: Seq[RelationshipInfo])(implicit toEntityMarshallerRelationshipInfoarray: ToEntityMarshaller[Seq[RelationshipInfo]]): Route =
            complete((200, responseRelationshipInfoarray))
  def getUserInstitutionRelationships400(responseProblem: Problem)(implicit toEntityMarshallerProblem: ToEntityMarshaller[Problem]): Route =
            complete((400, responseProblem))
        /**
        ...
        */
        def getUserInstitutionRelationships(institutionId: String, platformRoles: Option[String])
          ...
          def invalidateOnboarding200: Route =
            complete((200, "successful operation"))
  def invalidateOnboarding400(responseProblem: Problem)(implicit toEntityMarshallerProblem: ToEntityMarshaller[Problem]): Route =
            complete((400, responseProblem))
        /**
           * Code: 200, Message: successful operation
   * Code: 400, Message: Invalid ID supplied, DataType: Problem
        */
        def invalidateOnboarding(token: String)
          ...
          def suspendRelationship204: Route =
            complete((204, "Successful operation"))
  def suspendRelationship400(responseProblem: Problem)(implicit toEntityMarshallerProblem: ToEntityMarshaller[Problem]): Route =
            complete((400, responseProblem))
  def suspendRelationship404(responseProblem: Problem)(implicit toEntityMarshallerProblem: ToEntityMarshaller[Problem]): Route =
            complete((404, responseProblem))
        /**
           * Code: 204, Message: Successful operation
   * Code: 400, Message: Invalid id supplied, DataType: Problem
   * Code: 404, Message: Not found, DataType: Problem
        */
        def suspendRelationship(relationshipId: String)
            (implicit toEntityMarshallerProblem: ToEntityMarshaller[Problem], contexts: Seq[(String, String)]): Route
