...
trait PartyManagementService {
  ...
  def retrieveInstitution(institutionId: UUID)(bearerToken: String): Future[Institution]
  def retrieveInstitutionByExternalId(externalInstitutionId: String)(bearerToken: String): Future[Institution]

  def createPerson(person: PersonSeed)(bearerToken: String): Future[Person]

  def createInstitution(institution: InstitutionSeed)(bearerToken: String): Future[Institution]
